...
class WebSearchTool(Tool):
    """Search the web via proxy or Brave Search API."""
    ...
    def __init__(self, api_key: str | None = None, api_base: str | None = None, max_results: int = 5):
        ...
        self.api_base = api_base  # If set, use search proxy instead of Brave directly
    ...
    async def execute(self, query: str, count: int | None = None, **kwargs: Any) -> str:
        ...
        try:
            if self.api_base:
                return await self._search_via_proxy(query, n)
            else:
                return await self._search_brave(query, n)
        except Exception as e:
            return f"Error: {e}"

    async def _search_via_proxy(self, query: str, n: int) -> str:
        """Search via platform proxy (Serper/Google)."""
    ...
    async def _search_brave(self, query: str, n: int) -> str:
        """Search directly via Brave Search API."""
        async with httpx.AsyncClient() as client:
            r = await client.get(
